...
import useFetchUpcomingConferences from "../../utils/conference-list/useFetchUpcomingConferences";

export const UpcomingConferenceList = ({ userRole }: any) => {
  const {
    conferences,
    isLoading,
    error: fetchError,
  } = useFetchUpcomingConferences();
  const {
