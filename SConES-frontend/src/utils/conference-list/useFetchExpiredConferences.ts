...
const useFetchExpiredConferences = () => {
  ...
  useEffect(() => {
    const fetchConferences = async () => {
      const url = `http://${process.env.REACT_APP_BACKEND_HOST}:${process.env.REACT_APP_BACKEND_PORT}/api/conferences/expired`;
...
export default useFetchExpiredConferences;
